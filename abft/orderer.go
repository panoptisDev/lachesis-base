...
import (
	...
	"github.com/panoptisDev/lachesis-base/abft/election"
...
type OrdererCallbacks struct {
	ApplyAtropos func(decidedFrame idx.Frame, atropos hash.Event, electing hash.Event) (sealEpoch *pos.Validators)
